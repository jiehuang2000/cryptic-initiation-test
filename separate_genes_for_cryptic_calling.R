...
for(i in 1:nrow(WT_rep1.mat)){
  ...
  system(paste0("bsub -M 30 -q week -J gene",i," Rscript /proj/strahllb/users/Austin/Stephen/nutrient_deprivation/determine_cryptic_jumps_and_rates.R gene_",i,"_WTavg_MUTavg.txt gene_",i,"_WTavg_MUTavg_out.txt"))
}
